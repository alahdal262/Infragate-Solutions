    ...
    <div className="relative overflow-hidden bg-slate-950">
      ...
      <section className="relative pt-24 pb-40 flex items-center justify-center overflow-hidden min-h-[90vh]">
        ...
        <div className="absolute inset-0 z-0 pointer-events-none">
          <div className="absolute top-[-20%] right-[-10%] w-[800px] h-[800px] bg-brand-600/10 rounded-full blur-[120px] animate-pulse"></div>
          <div className="absolute bottom-[0%] left-[-10%] w-[800px] h-[800px] bg-indigo-600/10 rounded-full blur-[120px]"></div>
          <div className="absolute top-[40%] left-[50%] transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-sky-500/5 rounded-full blur-[100px]"></div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-slate-900/80 border border-slate-700/50 backdrop-blur-md mb-10 animate-in fade-in slide-in-from-bottom-5 duration-700 shadow-xl">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-extrabold tracking-tight text-white mb-8 leading-[1.1] animate-in fade-in slide-in-from-bottom-8 duration-1000">
          ...
          <p className="mt-6 max-w-3xl mx-auto text-xl text-slate-400 mb-12 animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-100 leading-relaxed font-light">
            We are the British engineering standard for complex government platforms, secure enterprise architectures, and mission-critical AI applications. We deliver <span className="text-slate-200 font-medium">clarity</span> in complexity and <span className="text-slate-200 font-medium">security</span> by design.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-200">
            <Button size="lg" onClick={() => onNavigate(PageView.SERVICES)} icon={<ArrowRight className="w-5 h-5"/>} className="shadow-brand-500/25 shadow-xl">
              View Capabilities
            </Button>
          ...
          {/* Stats Bar */}
          <div className="mt-24 pt-8 border-t border-slate-800/60 grid grid-cols-2 md:grid-cols-4 gap-8 animate-in fade-in delay-300 duration-1000 text-left md:text-center">
            <div>
              <p className="text-3xl font-bold text-white mb-1">100%</p>
              <p className="text-xs text-slate-500 uppercase tracking-widest font-semibold">UK Sovereign Code</p>
            </div>
             <div>
              <p className="text-3xl font-bold text-white mb-1">ISO</p>
              <p className="text-xs text-slate-500 uppercase tracking-widest font-semibold">27001 Aligned</p>
            </div>
             <div>
              <p className="text-3xl font-bold text-white mb-1">99.99%</p>
              <p className="text-xs text-slate-500 uppercase tracking-widest font-semibold">Uptime SLA</p>
            </div>
             <div>
              <p className="text-3xl font-bold text-white mb-1">24/7</p>
              <p className="text-xs text-slate-500 uppercase tracking-widest font-semibold">Support & Ops</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                <div className="flex items-center gap-2 text-white font-medium bg-slate-800 px-4 py-2 rounded-lg border border-slate-700">
            ...
            <div className="relative">
              <div className="absolute -inset-4 bg-gradient-to-r from-brand-500 to-indigo-600 rounded-2xl opacity-30 blur-lg"></div>
              <div className="relative bg-slate-950 border border-slate-800 rounded-2xl p-8 overflow-hidden">
      ...
      <section className="py-24 bg-slate-950 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Large Card */}
            <div className="md:col-span-2 relative group overflow-hidden rounded-3xl bg-slate-900 border border-slate-800 hover:border-brand-500/50 transition-all duration-500 cursor-pointer" onClick={() => onNavigate(PageView.SERVICES)}>
              ...
              <div className="relative z-20 p-10 h-full flex flex-col justify-end min-h-[450px]">
                ...
                <div className="flex flex-wrap gap-3">
                  <span className="px-4 py-1.5 rounded-full bg-slate-800 text-sm text-brand-300 border border-slate-700">GovTech</span>
                  <span className="px-4 py-1.5 rounded-full bg-slate-800 text-sm text-brand-300 border border-slate-700">WCAG 2.1 AA</span>
                  <span className="px-4 py-1.5 rounded-full bg-slate-800 text-sm text-brand-300 border border-slate-700">Cyber Essentials Plus</span>
                </div>
              </div>
            </div>

            {/* Side Card 1 */}
            <div className="group rounded-3xl bg-slate-900 border border-slate-800 p-8 hover:bg-slate-800/50 transition-colors duration-300 flex flex-col justify-between">
              <div>
            ...
            <div className="group rounded-3xl bg-slate-900 border border-slate-800 p-8 hover:bg-slate-800/50 transition-colors duration-300 flex flex-col justify-between">
             ...
             {/* Bottom Wide Card */}
             <div className="md:col-span-3 bg-gradient-to-r from-slate-900 to-slate-800 rounded-3xl p-10 border border-slate-700/50 relative overflow-hidden group">
      ...
      <section className="py-20 bg-slate-950">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
           <div className="bg-brand-900/20 border border-brand-500/30 rounded-3xl p-12 md:p-20 relative overflow-hidden text-center backdrop-blur-sm">
